...
* Day 5 **Даниил Артамонов**, отвечает за платформу внутренних ИИ‑агентов и самих агентов, ускоряющих разработку, тестирование и запуск проектов в Яндекс Лавке; **Кирилл Власов**, отвечает за развитие *AI Studio - Yandex Cloud*
  * [YT - Д. Артамонов: Production Engineering for LLM Agents](https://www.youtube.com/live/sNemTIFlz08)
